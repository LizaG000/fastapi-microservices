...
from user_microservice.presentation.fastapi.routes.core.setup import setup_core_router
from user_microservice.presentation.fastapi.exception_handlers import setup_exception_handlers
